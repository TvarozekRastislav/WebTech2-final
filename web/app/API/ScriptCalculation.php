...
class ScriptCalculation             //odtialto sa tahaju metody pre ziskavanie dat pripadne vykonanie commnadu ktory pouzivatel zadal
                                    //tieto funkcie ich uz aj rozparsuju do premennych pouzite var_dump ak chcete vidiet strukturu premennych
{

    public function runOctaveCommand($command){
        exec('octave-cli --eval "try '.$command.' catch err = lasterror.message end_try_catch"', $o[]);
        return $o;
    }

    public function handleOutputT($r){
    ...
    public function handleOutput_Y($r){
        exec('octave-cli --eval " m1 = 2500; m2 = 320;k1 = 80000; k2 = 500000;b1 = 350; b2 = 15020;pkg load control;A=[0 1 0 0;-(b1*b2)/(m1*m2) 0 ((b1/m1)*((b1/m1)+(b1/m2)+(b2/m2)))-(k1/m1) -(b1/m1);b2/m2 0 -((b1/m1)+(b1/m2)+(b2/m2)) 1;k2/m2 0 -((k1/m1)+(k1/m2)+(k2/m2)) 0];B=[0 0;1/m1 (b1*b2)/(m1*m2);0 -(b2/m2);(1/m1)+(1/m2) -(k2/m2)];
    ...
    public function handleOutput_X($r){
        exec('octave-cli --eval  "m1 = 2500; m2 = 320;k1 = 80000; k2 = 500000;b1 = 350; b2 = 15020;pkg load control;A=[0 1 0 0;-(b1*b2)/(m1*m2) 0 ((b1/m1)*((b1/m1)+(b1/m2)+(b2/m2)))-(k1/m1) -(b1/m1);b2/m2 0 -((b1/m1)+(b1/m2)+(b2/m2)) 1;k2/m2 0 -((k1/m1)+(k1/m2)+(k2/m2)) 0];B=[0 0;1/m1 (b1*b2)/(m1*m2);0 -(b2/m2);(1/m1)+(1/m2) -(k2/m2)];
